"""UIB blocks copied verbatim from /home/selim/git_repos/MobileNetV4/models/blocks.py.
No modifications — kept as-is so the source is reviewable.

Key exports:
  UniversalInvertedResidual — configurable NAS block for FPN neck fusion layers
  MobileAttention           — mobile-friendly attention block (for hybrid variants)

UIB variant reference (controlled via dw_kernel_size_* knobs):
  ...
  FFN / pointwise-only:        dw_start=0, dw_mid=0, dw_end=0
"""
